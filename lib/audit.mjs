...
const emptySeverities = () => ({ critical: 0, high: 0, moderate: 0, low: 0, total: 0 })
 ...
 * pnpm-Installation misst nichts Brauchbares. pnpm gibt bei `--json` dieselbe
 * Form aus wie npm — `metadata.vulnerabilities` mit denselben Schlüsseln —,
 * deshalb liest `parseNpmAudit` beide.
 *
 ...
 */
export function jsAuditCommand(lockfiles) {
