...
export function renderAudit(report, { generatedAt } = {}) {
  ...
  if (withBaseline.length > 0) {
    ...
    lines.push('3. Einmalig durchformatieren (ein eigener Commit, wenn kein Branch offen ist).')
    lines.push('4. CI-Vorlage aus `examples/` kopieren, erst report-only, dann als Required Check.')
  } else {
    lines.push('2. Einmalig durchformatieren (ein eigener Commit, wenn kein Branch offen ist).')
